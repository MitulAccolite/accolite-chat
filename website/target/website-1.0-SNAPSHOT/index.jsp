...
<head>
    ...
    <link href="/resources/theme1/css/landing_page.css" rel="stylesheet">
    ...
    <style>
        .features{
            ...
            text-align:center;
            color:#fff;
            background:url(resources/theme1/img/Features.jpg) bottom center no-repeat #000;
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <a href="#about" class="btn btn-circle page-scroll pagedown-arrow">
    ...
    <div class="features">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2">
                <h2>About Chat Application</h2><br/>
                <a href="#contact" class="btn btn-circle page-scroll pagedown-arrow">
                    <i class="fa fa-angle-double-down animated"></i>
                </a>
            </div>
        </div>
